...
jsonSource_Departamentos_ENP_2.addFeatures(features_Departamentos_ENP_2);var lyr_Departamentos_ENP_2 = new ol.layer.Vector({
            ...
            });var format_CubrimientoMunicipalENP_3 = new ol.format.GeoJSON();
var features_CubrimientoMunicipalENP_3 = format_CubrimientoMunicipalENP_3.readFeatures(json_CubrimientoMunicipalENP_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CubrimientoMunicipalENP_3 = new ol.source.Vector({
    attributions: '<a href=""></a>',
});
jsonSource_CubrimientoMunicipalENP_3.addFeatures(features_CubrimientoMunicipalENP_3);var lyr_CubrimientoMunicipalENP_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_CubrimientoMunicipalENP_3, 
                style: style_CubrimientoMunicipalENP_3,
                title: '<img src="styles/legend/CubrimientoMunicipalENP_3.png" /> Cubrimiento Municipal ENP'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_Limite_Colombia_1.setVisible(true);lyr_Departamentos_ENP_2.setVisible(true);lyr_CubrimientoMunicipalENP_3.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_Limite_Colombia_1,lyr_Departamentos_ENP_2,lyr_CubrimientoMunicipalENP_3];
...
lyr_CubrimientoMunicipalENP_3.set('fieldAliases', {'DEPT': 'DEPT', 'MUNICIPIO': 'MUNICIPIO', });
...
lyr_CubrimientoMunicipalENP_3.set('fieldImages', {'DEPT': 'TextEdit', 'MUNICIPIO': 'TextEdit', });
...
lyr_CubrimientoMunicipalENP_3.set('fieldLabels', {'DEPT': 'inline label', 'MUNICIPIO': 'inline label', });
lyr_CubrimientoMunicipalENP_3.on('precompose', function(evt) {
